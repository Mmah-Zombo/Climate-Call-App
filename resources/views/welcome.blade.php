...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased hover:cursor-default">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-dots-lighter bg-purple-400 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6  text-right z-10">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-whihte hover:text-green-400  focus:outline focus:outline-2 focus:rounded-sm focus:outline-green-400 p-2 bg-purple-400 rounded text-lg">Dashboard</a>
                    @else
        ...
        <div class="w-full p-10 md:p-20 bg-celadon">
            ...
            <div class="mt-10 w-full h-fit md:grid grid-cols-3 gap-5">
                ...
                <div class="w-full h-100 md:h-80 bg-white p-4 md:pl-10 text-center">
                    ...
                    <p class="text-xl">You share your thoughts and useful information related to climate change. This gives you the ability to not only help other know more about climate issues, it also helps you to gain more knowledge as well.</p>
                </div>
